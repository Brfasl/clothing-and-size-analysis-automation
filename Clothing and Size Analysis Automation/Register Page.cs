...
namespace Login_And_Register_Page
{
    public partial class RegisterPage : Form
    {
        ...
        private void registerForCustomer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                string query = "INSERT INTO registerForCustomer (Username, Email, Password) VALUES (@username, @email, @password)";
        ...
        private void registerForSeller_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                string query = "INSERT INTO registerForSeller (Username, Email, Password) VALUES (@username, @email, @password)";
                SqlCommand cmd = new SqlCommand(query, con);
